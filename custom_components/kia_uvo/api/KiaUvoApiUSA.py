...
class KiaUvoApiUSA:
    ...
    async def login(self, username: str, password: str) -> str:
        ...
        response: ClientResponse = await self._post_request_with_logging_and_active_session(session_id=None, vehicle_key=None, url=url, json_body=data)
    ...
    async def get_vehicles(self, session_id: str):
        ...
        response: ClientResponse = await self._get_request_with_logging_and_active_session(session_id=session_id, vehicle_key=None, url=url)
        response_json = await response.json()
    ...
    async def check_last_action_status(self, session_id: str, vehicle_key: str, xid: str):
    ...
    async def set_charge_limits(self, session_id: str, vehicle_key: str, ac_limit: int, dc_limit: int):
